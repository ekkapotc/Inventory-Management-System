...
<?php
    ...
    $budgetCat = $_POST['budget'];
    $inventoryNo = $_POST['inventory_no'];

    //select the given row from the respective table
    $strSQL = "SELECT * FROM $budgetCat WHERE EquipmentID = '$inventoryNo'";
            ...
            echo'<center>
                    ...
                    <table width="700" border="1">
                        ...
                        <tr>';
                            ...
                            }else if($budgetCat==="Budget2"){
                                echo 'งบเงินรายได้';
                            }else if($budgetCat==="Budget3"){
                                echo 'งบเก่า';
                            }else if($budgetCat==="Budget4"){
                                echo 'งบสาขา MPE';
                            }
                            echo '</td></tr></div></th>';
...
<!-- form -->
    <form action="update.php" method="POST">
        ...
        <!--input name="status" type="radio" value="รอซ่อม"> รอซ่อม </input-->
        </div>
        ...
        <div id="lastseen">
        <!-- พบครั้งสุดท้าย: <input type="text" name="lastseen" value="<?php echo $lastseen;?>"> -->
...
<center>
    <button onclick="javascript:goBack(-1)">กลับไปหน้าหลัก</button>
</center>
